...
const CORE: NavItem[] = [
  ...
  { id: "myai", label: "我的 AI", sub: "装机 · 体检 · 启动", icon: Sparkles },
  ...
  { id: "manage", label: "AI 设置", sub: "换模型 · 余额", icon: Cpu },
];
...
const MORE: NavItem[] = [
  ...
  // U盘工具盘 2026-09-08 隐藏（用户决定下架，入口先藏、后端不动，P2 合流在研不受影响）。
  // 恢复：解开下一行即可（路由在 App.tsx 同样被摘掉，两处一起恢复）。
