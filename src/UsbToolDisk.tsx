...
export function UsbToolDisk({ onToast }: { onToast?: (message: string) => void }) {
  ...
  const [busy, setBusy] = useState<"inspect" | "deploy" | "verify" | "launch" | null>(null);
