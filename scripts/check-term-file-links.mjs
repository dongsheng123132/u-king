...
const RESOLVE_HOME = [
  ["~\\.pi\\agent\\skills\\SKILL.md", "D:\\proj", "C:\\Users\\example", "C:\\Users\\example\\.pi\\agent\\skills\\SKILL.md", "Windows ~ 展开"],
  ["~/x/y.txt", "/d/proj", "C:/Users/example", "C:/Users/example/x/y.txt", "Mac 风格 ~ 展开"],
  ["~/x/y.txt", "/d/proj", undefined, undefined, "不传 home 时行为不变（照旧拼 cwd）"],
  ["~abc/x", "D:\\proj", "C:\\Users\\example", undefined, "~ 后不是分隔符 = 用户名形式，不许展开"],
];
